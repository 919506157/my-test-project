...
public class GenerateTestUserSig {
     ...
     * 它是腾讯云用于区分客户的唯一标识。
     */
    public static final int SDKAPPID = 1400367050;
     ...
     */
    private static final String SECRETKEY = "8648fe0fbb4b004edc5956a4c7ceb2c443b36941190dc5a3119cd994ab1ad13f";
    ...
    private static String GenTLSSignature(long sdkappid, String userId, long expire, byte[] userbuf, String priKeyContent) {
        ...
        if (null != userbuf) {
            ...
            base64UserBuf = encoder.encodeToString(userbuf);
    ...
    private static String hmacsha256(long sdkappid, String userId, long currTime, long expire, String priKeyContent, String base64Userbuf) {
        ...
        try {
            ...
            byte[] encode = encoder.encode(byteSig);
    ...
    private static byte[] base64EncodeUrl(byte[] input) {
        ...
        byte[] base64 = encoder.encodeToString(input).getBytes();
